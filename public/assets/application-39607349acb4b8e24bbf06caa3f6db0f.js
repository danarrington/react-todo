...
var NewTodo = React.createClass({displayName: "NewTodo",
  ...
  render() {
    return (
      React.createElement("a", {href: "#", onClick: this.props.container.toggleDisplay}, "+ New Todo")
    );
  }
  
});
var NewTodoContainer = React.createClass({displayName: "NewTodoContainer",
  ...
  render() {
    return (
      React.createElement("div", {className: "new-todo"}, 
        
          this.state.showForm ? 
          React.createElement(NewTodoForm, {container: this}) : 
          React.createElement(NewTodo, {container: this})
...
var NewTodoForm = React.createClass({displayName: "NewTodoForm",
  ...
  render() {
    return (
      ...
      React.createElement("div", {className: "form-group"}, 
        ...
        React.createElement("button", {className: "new-todo-button", 
          onClick: this.saveTodo}, "Add to List"), 
        React.createElement("button", {className: "cancel-todo-button", 
          onClick: this.cancelTodo}, "Cancel")
      )
    );
  }
  
});
var CompleteBox = React.createClass({displayName: "CompleteBox",
...
var Header = React.createClass({displayName: "Header",
  ...
  render: function() {
    return React.createElement("div", {className: "header"}, "Todos (", this.props.count, ")")
  }
});
  ...
  render() {
    return (
      React.createElement("li", {className: "todo"}, 
        React.createElement("span", {className: "todo-title"}, 
          this.props.title
        ), 
        React.createElement(CompleteBox, {id: this.props.id, onFinishTodo: this.props.onFinishTodo})
      )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(Header, {count: this.props.todos.length}), 
        React.createElement(TodoList, {todos: this.props.todos, onFinishTodo: this.props.onFinishTodo}), 
        React.createElement(NewTodoContainer, {todosPath: this.props.todosPath, 
          onTodosUpdated: this.props.onTodosUpdated})
      )
    );
  }
});
var TodoAppContainer = React.createClass({displayName: "TodoAppContainer",
  componentWillMount() {
    this.fetchTodos();
  },
  ...
  render() {
    return React.createElement(TodoApp, {todos: this.state.todos, onFinishTodo: this.finishTodo, 
